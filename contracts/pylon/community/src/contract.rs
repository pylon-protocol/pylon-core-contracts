...
use pylon_token::community::{ConfigResponse, ExecuteMsg, InstantiateMsg, MigrateMsg, QueryMsg};
...
pub fn spend(
    ...
    let pylon_token = deps.api.addr_humanize(&config.pylon_token)?.to_string();
    Ok(Response::new()
