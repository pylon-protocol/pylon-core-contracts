...
use pylon_token::collector::{ConfigResponse, ExecuteMsg, InstantiateMsg};
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        ...
        pylon_token: "tokenMINE".to_string(),
...
fn test_sweep() {
    ...
    deps.querier
        .with_terraswap_pairs(&[(&"uusdtokenMINE".to_string(), &"pairMINE".to_string())]);
    ...
    assert_eq!(
        ...
        vec![SubMsg {
            msg: WasmMsg::Execute {
                contract_addr: "pairMINE".to_string(),
    ...
    assert_eq!(
        ...
        vec![
            SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
                contract_addr: "tokenMINE".to_string(),
